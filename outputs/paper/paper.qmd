---
title: "Is There a Correlation Between Preference and Perceptions of Inaction and Action in Decision-Making and Gender? An Analysis of Evaluations of Actions and Inaction Decision-makers in Risky Decisions Resulting in Negative Outcomes Study 2."
author: "Francesca Ye, Sky Suh and Hari Lee Robledo"
date: "today"
date-format: long
...
#| fig-cap: Distribution of Male Participants by Preference
...
#| fig-cap: Distribution of Female Participants by Preference
...
#| fig-cap: Comparison of Gender Distribution by Preference
...
#| fig-cap: Distribution of Male Participants by Competence Perception
...
#| fig-cap: Distribution of Female Participants by Competence Perception
...
#| fig-cap: Comparison of Gender Distribution by Competence
...
## Conclusion
Overall, we found and examined the correlation between preferences, competence and perceptions of inaction and age and gender reveals the understanding of moral judgement across cognitive science, psychology and philosophy. Like Gawronski et al., suggested and proposed through the CNI model, it shows the duty-based perspective and a tendency not to act since men are approached to make practical and action-oriented decisions, while women are more sensitive to moral norms and prefer inaction. However, the research by Qian et al., and Caprarp & Sieppel presents that gender differences in moral judgements are not large but likey happen due to cultural factors. Based on data from Study 2 of the original paper “Evaluations of Action and Inaction Decision-makers in Risky Decisions Resulting in Negative Outcomes” by Gilad Feldman, Adrien A. Fillon and Luna Strauch, we focused on understanding the differences in moral judgements between the decision-making approaches of the gender since Feldman et al.,’s research study did not explore the gender differences directly which is the key point for future investigation into how gender can interact with decision-making preferences and perception. Our analysis found no statistically significant differences in the preference and perceived competence between genders which both men and women preferred behavioural agents and perceived them to be more competent even though women had slightly stronger negative perceptions; these findings emphasize the intergender factors including the influence of cultural factors in the decision-making process. It encourages further research in this area with social intersectionality that advances the understanding of human behaviour, moral judgements and decision-making.
